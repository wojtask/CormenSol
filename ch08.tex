...
\[
	2^h \le l \le (k!)^{n/k},
\]
co po zlogarytmowaniu obustronnie i~skorzystaniu z~\refExercise{3.1-8} daje
\[
...
W~ogólności, jeżeli mamy liczby \twoparts{$d$}{cyfrowe}, to do ich posortowania tym algorytmem wymaganych jest co najwyżej $\sum_{i=0}^{d-1}10^i=(10^d-1)/9$ faz. Najwięcej tymczasowych fragmentów generuje się podczas faz sortujących po ostatnich cyfrach -- jest ich wtedy maksymalnie $9(d-1)+1$.
