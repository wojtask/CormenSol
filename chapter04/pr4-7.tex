...
\[
	...
	\end{cases}.
\]
Dodając stronami nierówności z~tego układu od $j$\nbhyphen tej do $l$\nbhyphen tej włącznie, a~następnie redukując powtarzające się składniki, otrzymujemy nierówność $A[1,j]+A[2,l]\le A[1,l]+A[2,j]$ z~tezy twierdzenia.
...
Na $i$\nbhyphen tym poziomie rekurencja ta wprowadza koszt równy $O(m/2^i+n)$.
