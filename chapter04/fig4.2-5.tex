...
\draw[arrow, <->, thick] (bottom 1) -- (bottom 1 |- root) node[pos=0.6, fill=white] {$\log_{1/\alpha}n$};
\draw[arrow, <->, thick] (bottom 2) -- (bottom 2 |- root) node[pos=0.2, fill=white] {$\log_{1/(1-\alpha)}n$};
