...
\subproblem %12-4(b)
Wyznaczmy $B^2(x)$.
Kwadrat sumy wyrazów ciągu jest sumą iloczynów wyrazów tego ciągu na zasadzie ,,każdy z~każdym''.
...
\]
Wewnętrzną sumę na podstawie punktu (a) zamieniamy na $b_{n+1}$ i~wówczas:
\[
...
Niech teraz $k\ge2$.
Wykorzystując założenie indukcyjne, wyznaczmy \singledash{$k$}{tą} pochodną funkcji $f(x)$:
\begin{align*}
