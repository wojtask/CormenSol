...
\exercise %12.2-8
Na podstawie \refExercise{12.2-6}, jeśli węzeł początkowy $u$ nie ma prawego syna, to w~wyniku wywołania $\proc{Tree-Successor}(u)$, następnym odwiedzonym węzłem będzie najniższy przodek $u$, którego lewy syn też jest przodkiem $u$.
