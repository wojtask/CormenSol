\begin{tikzpicture}[
	...
	outer/.append style = {node distance=22mm and 15mm}
]
...
\node[outer, right=28mm of pic a.north east, anchor=north west] (pic b) {
\begin{tikzpicture}[
	every node/.style = {tree node},
	anchor = center
]
...
\node[outer, below=of pic a.south west, anchor=north west] (pic c) {
\begin{tikzpicture}[
	every node/.style = tree node,
	anchor = center
]
