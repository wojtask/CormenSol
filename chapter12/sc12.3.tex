...
Procedura ta nie powinna być wywoływana bezpośrednio, gdyż nie aktualizuje ona pola \id{root} drzewa $T$, do którego wstawiany jest nowy węzeł $z$.
Czynność tę wykonuje poniższy pseudokod, który powinien być stosowany do skorzystania z~procedury \proc{Recursive-Tree-Insert}.
\begin{codebox}
