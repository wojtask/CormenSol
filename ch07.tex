...
Aby był to podział bardziej zrównoważony niż $1-\alpha$ do $\alpha$, to musi być $\alpha<\beta$.
...
Przyjmijmy, że przypadkiem brzegowym rekurencji jest $T(1)=1$.
Na podstawę indukcji możemy więc przyjąć $n=1$, dla którego $T(n)$ spełnia rozważane oszacowanie, a~zatem $T(n)=\Omega(n\lg n)$.
