...
Natomiast nadanie mu koloru czarnego spowodowałoby naruszenie własności 5 -- na prostej ścieżce od korzenia drzewa do liścia \const{nil}, będącego synem nowego węzła, znalazłoby się 5 czarnych węzłów, a~na prostej ścieżce od korzenia do dowolnego innego liścia \const{nil} byłyby 4 czarne węzły.
