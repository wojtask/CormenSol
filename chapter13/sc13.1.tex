...
Liczba czarnych węzłów na każdej ścieżce od korzenia do liścia zwiększa się o~1, a~liczba czarnych węzłów na ścieżce od dowolnego innego węzła do ich potomnych liści nie zmienia się.
Oznacza to, że także własność 5 nie będzie naruszona i~otrzymane drzewo będzie drzewem czerwono-czarnym.
