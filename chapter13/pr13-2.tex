...
Wówczas w~procedurze \proc{RB-Delete-Fixup} nie wykonuje się żadna iteracja pętli \kw{while}, więc sytuację tę należy wykrywać już w~trakcie wcześniej, np.\ w~wierszu 9 procedury \proc{RB-Delete}.
