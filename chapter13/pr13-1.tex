...
Skopiowane węzły sprzed wywołania \proc{RB-Delete-Fixup}, czyli z~punktu (a) przodków efektywnie usuniętego węzła (i~jego syna $x$ w~przypadku, gdy $\attrib{x}{color}=\const{red}$), można przechować na stosie, co pozwoli dostać się do nich bez użycia w~tym celu wskaźników na ojca.
