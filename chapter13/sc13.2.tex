...
\zi		\Then $\attribb{y}{left}{p}\gets x$
		\End
\end{codebox}
\note{Przyjmujemy, że procedury \proc{Left-Rotate} i~\proc{Right-Rotate} działają poprawnie także dla zwykłych drzew BST, zastępując odwołanie do\/ \attrib{T}{nil} z~wiersza 5 (oraz 3 -- patrz wyżej) przez \const{nil}.}
\bignegskip
