...
\exercise %13.2-4
\note{Przyjmujemy, że zadanie dotyczy drzew wyszukiwań binarnych, zgodnie z~treścią oryginalną.
Rotacje, o~których mówimy w~rozwiązaniu, są operacjami na drzewach wyszukiwań binarnych, których postać dla drzew czerwono-czarnych implementują procedury \proc{Left-Rotate} i~\proc{Right-Rotate}.
...
Ponadto zakładamy, że procedura \proc{Right-Rotate}, której liczbę wywołań szacujemy, została zaadaptowana do działania na drzewach wyszukiwań binarnych poprzez zastąpienie odniesienia do $\attrib{T}{nil}$ przez \const{nil}.}
