...
\noindent Wszystkie pomocnicze operacje, które opisaliśmy w~punkcie (b), tzn.\ \proc{Balance-Factor}, \proc{Height}, operacje rotacji oraz \proc{Balance} działają w~czasie stałym.
