...
\subsection{Asymptotyczne zachowanie wielomianów} %3-1
...
\subsection{Względny czas asymptotyczny} %3-2
...
\subsection{Porządkowanie ze względu na rząd wielkości funkcji} %3-3
...
\subsection{Własności notacji asymptotycznej} %3-4
...
\subsection{Wariacje na temat notacji $O$ i~$\Omega$} %3-5
...
\subsection{Funkcje iterowane} %3-6
