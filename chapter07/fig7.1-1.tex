...
\node[outer, below=of pic d.south] (pic e) {
\begin{tikzpicture}
	\matrix[
		array,
		light cell/.list = {1,2},
...
\node[outer, below=of pic e.south] (pic f) {
\begin{tikzpicture}
	\matrix[
		array,
		light cell/.list = {1,2},
...
\node[outer, below=of pic f.south] (pic g) {
\begin{tikzpicture}
	\matrix[
		array,
...
\node[outer, below=of pic h.south] (pic i) {
\begin{tikzpicture}
	\matrix[
		array,
...
\node[outer, below=of pic i.south] (pic j) {
\begin{tikzpicture}
	\matrix[
		array,
		light cell/.list = {1,2,3,4,5},
...
\node[outer, below=of pic j.south] (pic k) {
\begin{tikzpicture}
	\matrix[
		array,
...
\node[outer, below=of pic k.south] (pic l) {
\begin{tikzpicture}
	\matrix[
		array,
...
\node[outer, below=of pic l.south] (pic m) {
\begin{tikzpicture}
	\matrix[
		array,
		light cell/.list = {1,2,3,4,5,6,7},
...
\foreach \x in {b,c,d,e,f,g} {
	\node[subpicture label, anchor=south] at (label a |- pic \x.south west) (label \x) {(\x)};
}

\node[subpicture label, left=1mm of pic h.south west, anchor=south] (label h) {(h)};
\foreach \x in {i,j,k,l,m} {
	\node[subpicture label, anchor=south] at (label h |- pic \x.south west) (label \x) {(\x)};
}
