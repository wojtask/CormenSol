...
\bigskip
\noindent\textbf{Dane wejściowe:} \onedash{$n$}{elementowe} tablice $A$ i~$B$ zawierające reprezentacje binarne \onedash{$n$}{bitowych} liczb całkowitych nieujemnych $a$ i~$b$.\\
