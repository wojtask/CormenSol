...
Pętla \kw{while} w~wierszach \ref{li:compactify-list-while2-begin}\nbendash\ref{li:compactify-list-while2-end} wyznacza $y$ poprzez liniowe przeglądanie tablicy \id{prev}, po czym w~wierszu \ref{li:compactify-list-swap} elementy $x$ i~$y$ zamieniają swoje pozycje.
