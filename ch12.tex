...
Ścieżki pokonywane w~obu procedurach są zatem identyczne, przy czym proceudra \proc{Tree-Search} porówna jeszcze poszukiwany klucz z~węzłem o~tym kluczu na końcu tej ścieżki.
