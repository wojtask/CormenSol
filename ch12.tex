...
Wówczas drzewo powstałe po serii $n$ operacji \proc{Tree-Insert} jest wysokości $n-1$.
...
Drzewo zawierające $n$ węzłów ma wysokość co najmniej $\lfloor\lg n\rfloor$ (z~\refExercise{B.5-4}).
