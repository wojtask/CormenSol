...
$2.\Rightarrow 3.$: Załóżmy, że $G$ jest \singledash{2}{kolorowalny} i~że ma cykl nieparzysty $\langle v_1,v_2,\dots,v_{2k+1},v_1\rangle$ dla pewnego $k\ge1$.
...
\subproblem %B-1(d)
Jeżeli $k$ barw wystarcza do optymalnego pokolorowania grafu $G$ (czyli takiego, które wykorzystuje możliwie najmniej kolorów), to dla każdych dwóch różnych barw istnieje krawędź w~$E$ incydentna z~wierzchołkami o~takich barwach.
