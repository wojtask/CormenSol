...
\[
	...
	\end{cases}.
\]
Dodając stronami nierówności z~powyższego układu od \onedash{$j$}{tej} do \onedash{$l$}{tej} włącznie, a~następnie redukując powtarzające się składniki, otrzymujemy nierówność $A[1,j]+A[2,l]\le A[1,l]+A[2,j]$ z~tezy twierdzenia.
