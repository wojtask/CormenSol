...
\subsection{Przykłady rekurencji} %4-1
...
\subsection{Szukanie brakującej liczby całkowitej} %4-2
...
\subsection{Koszty przekazywania parametrów} %4-3()
...
\subsection{Więcej przykładów rekurencji} %4-4
...
\subsection{Liczby Fibonacciego} %4-5
...
\subsection{Testowanie układów VLSI} %4-6
...
\subsection{Tablice Monge'a} %4-7 %poprawic, dokonczyc
...
\[
	...
	\end{cases}
\]
Na \twoparts{$i$}{tym} poziomie, rekurencja wprowadza koszt równy $O(m/2^i+n)$. Łatwo zauważyć, że jest $\lfloor\lg m\rfloor$ poziomów, a zatem całkowity koszt wynosi
\begin{align*}
