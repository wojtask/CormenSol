...
Przez $A_i$ będziemy rozumieć zdarzenie oznaczające wystąpienie sukcesu w~$i$\nbhyphen tej próbie w~ciągu $A$, a~przez $A_i'$ -- zdarzenie oznaczające sukces w~$i$\nbhyphen tej próbie w~ciągu $A'$.
Jeśli zachodzi $A_i$, to przyjmiemy, że zachodzi także $A_i'$.
W~przeciwnym przypadku będziemy generować sukces w~$i$\nbhyphen tej próbie ciągu $A'$ z~pewnym prawdopodobieństwem $r_i$.
