...
\exercise %16.5-2
Opiszemy metodę wymagającą czasu $O(n)$, ale oszacowanie to nie spowoduje powiększenia złożoności $O(n^2)$ algorytmu opartego na \proc{Greedy}, który rozwiązuje cały problem.
