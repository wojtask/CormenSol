...
Każda składowa grafu $G_{A'}$ byłaby więc tzw.\ \textbf{grafem eulerowskim} i~jako taka miała cykl Eulera, o~czym mówi problem \refProblem{22-3} zmodyfikowany do wersji nieskierowanych grafów.
...
Aby wartość ta była maksymalizowana, wystarczy zastosować w~tym algorytmie funkcję wagową zmodyfikowaną według pomysłu z~\refExercise{16.4-5}.
...
Nie istnieje zatem jednoznaczne odwzorowanie między matroidem z~\refExercise{16.4-2} a~strukturą z~punktu (d), która matroidem nie jest.
