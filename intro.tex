...
\begin{itemize}
    \item wersja 0.8: dodanie rozwiązań z~części V, dokończenie problemu \refProblem{16-4},
    \item wersja 0.9: dodanie rozwiązań z~części VI, weryfikacja problemu \refProblem{15-5},
