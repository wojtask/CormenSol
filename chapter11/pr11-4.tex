...
Dla każdej \singledash{$n$}{tki} $a=\langle a_0,a_1,\dots,a_{n-1}\rangle\in U$ definiujemy funkcję haszującą $h_a$ jako
	...
	\]
	Udowodnij, że rodzina $\mathcal{H}=\{h_a:a\in U\}$ jest uniwersalna, ale nie jest \singledash{2}{uniwersalna}.
...
\subproblem %11-4(b)
Aby zbadać \singledash{2}{uniwersalność} rodziny $\mathcal{H}$, wykorzystamy pomysł ze wskazówki.
