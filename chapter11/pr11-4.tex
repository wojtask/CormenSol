\problem{Haszowanie $k$\nbhyphen uniwersalne i~uwierzytelnianie} %11-4
...
Wnioskujemy stąd, że uzyskanie każdej takiej pary jest jednakowo prawdopodobne, gdy funkcja $h_{a,b}'$ jest wybrana losowo z~$\mathcal{H}'$, a~to oznacza, że rodzina $\mathcal{H}'$ jest 2\nbhyphen uniwersalna.
